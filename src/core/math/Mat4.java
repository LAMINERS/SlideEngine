...
public class Mat4 {
	...
	public Mat4 Orthographic2D(int width, int height)
	{
	...
	public Mat4 Translation(Vec3f translation)
	{
	...
	public Mat4 Rotation(Vec3f rotation)
	{
		Mat4 rx = new Mat4();
		Mat4 ry = new Mat4();
		Mat4 rz = new Mat4();
	...
	public Mat4 Scaling(Vec3f scaling)
	{
	...
	public Mat4 OrthographicProjection(float l, float r, float b, float t, float n, float f){
	...
	public Mat4 PerspectiveProjection(float fovY, float width, float height, float zNear, float zFar)
	{
	...
	public Mat4 View(Vec3f forward, Vec3f up)
	{
		Vec3f f = forward;
		Vec3f u = up;
		Vec3f r = u.cross(f);
